...
class VisionTab:
    ...
    def load_save_frame(self, img_name, entry:ttk.Entry, label):
        ...
        setattr(self, img_name, deepcopy(loaded_image)) 
...
# Función para actualizar las imágenes en la interfaz
    ...
    def _create_image_with_text(self, text, aspect_ratio:float=0.5):
        ...
        try:
            font = ImageFont.truetype(f"{self.file_path}/proyecto-final-venv\Include\Montserrat-Regular.ttf", 20)  # Usa una fuente si está disponible
        except IOError:
